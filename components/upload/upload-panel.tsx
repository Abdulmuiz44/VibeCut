...
export function UploadPanel({ projectId }: { projectId: string }) {
  ...
  return (
    <section className="mt-8 grid gap-4 rounded-[1.75rem] border border-[hsl(var(--border))] bg-[hsl(var(--card)/0.72)] p-5 lg:grid-cols-[1fr_280px] lg:p-6">
      <div>
        <h3 className="text-xl font-semibold tracking-tight text-[hsl(var(--foreground))]">Upload source video</h3>
        ...
        <div className="mt-4 h-2 overflow-hidden rounded-full bg-[hsl(var(--secondary))]">
      ...
      <div className="surface-card p-4">
        ...
        <ul className="mt-4 space-y-2 text-sm text-[hsl(var(--foreground))]">
          <li className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--background)/0.6)] px-3 py-2">MP4</li>
          <li className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--background)/0.6)] px-3 py-2">MOV</li>
          <li className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--background)/0.6)] px-3 py-2">WebM</li>
        </ul>
        <p className="muted mt-4">Large files are uploaded with retry support. The editor refreshes when the file is ready.</p>
        {isUploading ? <p className="mt-4 text-xs uppercase tracking-[0.2em] text-[hsl(var(--primary))]">Uploading</p> : null}
      </div>
    </section>
  );
}
